...
type WorkoutAction =
  ...
  | {
      ...
      payload: { workoutId: string; exercises: Exercise[] };
    }
  | {
      type: "ADD_SET";
      payload: { workoutId: string; exerciseId: string; set: WorkoutSet };
    }
  | {
      type: "UPDATE_SET";
      payload: { workoutId: string; exerciseId: string; set: WorkoutSet };
  ...
  | {
      type: "DELETE_SET";
      payload: { workoutId: string; exerciseId: string; setId: string };
    }
